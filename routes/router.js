...
const allowedOrigins = ['https://brivnet.com', 'http://localhost:3000', 'http://127.0.0.1:5500'];
...
//messges
router.put("/message/update-read-status", bodyParser, isJSON, messageController.updateReadStatus)
